...
var poplayer = {
	...
	html:function(text,btn1,btn2,inputflag){
		...
		pop_tip_html += '.pop_tip .pop_tip_box{position: absolute;top: 34%;width: 400px;left: 45%;margin-left:-150px;background: #fff;z-index: 1000;text-align: center;border-radius: 10px;}';
		...
		pop_tip_html += '.pop_tip .pop_tip_btn_box #pop_tip_btn1{background:#FC6701;}';
